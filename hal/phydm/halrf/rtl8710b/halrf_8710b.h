...
#ifndef __HAL_PHY_RF_8710B_H__
#define __HAL_PHY_RF_8710B_H__

/*--------------------------Define Parameters-------------------------------*/
#define	IQK_DELAY_TIME_8710B		10		/* ms */
#define	index_mapping_NUM_8710B	15
#define AVG_THERMAL_NUM_8710B	4
#define RF_T_METER_8710B 0x42
...
phy_ap_calibrate_8710b(
	...
	s8		delta);
void
phy_digital_predistortion_8710b(struct _ADAPTER	*p_adapter);
#endif
...
#endif	/*  #ifndef __HAL_PHY_RF_8710B_H__ */
