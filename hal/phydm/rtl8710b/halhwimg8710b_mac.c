...
void
odm_read_and_config_mp_8710b_mac_reg(
	struct	PHY_DM_STRUCT *p_dm
)
{
	u32	i = 0;
	...
	u32	array_len = sizeof(array_mp_8710b_mac_reg)/sizeof(u32);
	u32	*array = array_mp_8710b_mac_reg;

	u32	v1 = 0, v2 = 0, pre_v1 = 0, pre_v2 = 0;

	PHYDM_DBG(p_dm, ODM_COMP_INIT, ("===> odm_read_and_config_mp_8710b_mac_reg\n"));
	...
	while ((i + 1) < array_len) {
		...
		if (v1 & (BIT(31) | BIT(30))) {/*positive & negative condition*/
			...
			if (is_matched)
				odm_config_mac_8710b(p_dm, v1, (u8)v2);
		}
		i = i + 2;
	}
}
